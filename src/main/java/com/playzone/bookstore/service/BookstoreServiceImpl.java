...
public class BookstoreServiceImpl implements BookstoreService{
	...
	@Override
	public Mono<Book> createMono(Book p) {
		return reactiveBookstoreRepository.save(p);
	}

	@Override
	public void update(Book p) {		
		reactiveBookstoreRepository.save(p);		
	}

	@Override
	public void delete(UUID id) {
		reactiveBookstoreRepository.deleteById(id);		
	}
